...
void CG_DrawActive()
{
  ...
  cl.cgameKickAngles[0] = angles->kickAngles[0] + cg.offsetAngles[0];
  cl.cgameKickAngles[1] = cg.offsetAngles[1] + angles->kickAngles[1];
  cl.cgameKickAngles[2] = cg.offsetAngles[2] + angles->kickAngles[2];
