...
struct IClientUtils
{
	AppId_t CPPCALL (*SetAppIDForCurrentPipe)( classptr_t pclass, AppId_t nAppID, bool bTrackProcess );
	AppId_t CPPCALL (*GetAppID)(classptr_t pclass);
	void CPPCALL (*SetAPIDebuggingActive)( classptr_t pclass, bool bActive, bool bVerbose );
	classptr_t pclass;
};
