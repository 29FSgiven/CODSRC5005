...
SET FLAGS=-m32 -Wall -Os -g -c -I. -DLTC_NO_ROLC -DLTC_SOURCE
SET MATHFLAGS=-m32 -Wall -Os -g -c -I. -Imath -DLTC_NO_ROLC -DLTC_SOURCE
...
ar cr libtomcrypt.a ..\..\..\common\tomcrypt\*.o
