...
#define EXEOBFUS_STATICKEY "sdf-08i930w4utrtfjj"


INLINE const char *EXEOBFUS_STATIC_STRING_DECRYPT(volatile const char *cipherstring, char *cleartext)
{
...
INLINE void ZZ_strlcat( char *dest, size_t size, const char *src, size_t cpylimit) {
