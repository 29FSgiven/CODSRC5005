...
SET FLAGS=-m32 -Wall -Os -s -c -I. -DLTC_NO_ROLC -DLTC_SOURCE -DLTC_NO_TEST -DLTC_NO_ECC_TIMING_RESISTANT
SET MATHFLAGS=-m32 -Wall -Os -s -c -I. -Imath -DLTC_NO_ROLC -DLTC_SOURCE -DLTM_DESC
...
gcc %FLAGS% pk\asn1\der\teletex_string\*.c
gcc %FLAGS% pk\dh\*.c
gcc %FLAGS% pk\rsa\*.c
