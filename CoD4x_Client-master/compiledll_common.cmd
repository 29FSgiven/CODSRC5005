...
REM nasm -w+all -f win32 ../src/hackbypass.asm --prefix _ -o hackbypass_asm.o
...
gcc.exe -c %FLAGS% "../src/sys_anticheatloader.c"
...
gcc.exe -c %FLAGS_O3% "../src/antireversing/antireversing.c"
::g++.exe -s -fno-strict-aliasing -c -O3 "../src/antireversing/antireversing.c"

:: -D CRCDEBUG 
:: -D NOD3DVALIDATION
:: -D NOANTIREVERSING
:: gcc.exe -c %FLAGS_O3% "../src/antireversing/LoadDLL.c" 
g++.exe -s -fno-strict-aliasing -c %FLAGS_O3% "../src/antireversing/LoadDLL.c" 
gcc.exe -c %FLAGS_O3% "../src/hackbypass.c"
...
cd "../"
echo Linking...
g++.exe -shared %FLAGS% -o bin/%binfilename%.dll bin/*.o sbin/*.o mingwcrt/*.o -Llib/ -ludis86 -ltomcrypt -lmbedtls_win32 -ldiscord_rpc -lstdc++ -static -nostdlib -lgcc -lgcc_eh -lmingwex -lmingw32 -lversion -lseh -lkernel32 -ladvapi32 -lole32 -loleaut32 -luuid -lwsock32 -lws2_32 -lwinmm -lshell32 -luser32 -lgdi32 -lcrypt32 -ld3dx9_34 -lpsapi -lfreetype -lmsvcr100 -Wl,-Map=%bindir%\%binfilename%.map,-fPic,--stack,8388608
